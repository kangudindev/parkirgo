...
Route::get('/test-koneksi', function() {
    return response()->json(['status' => 'ok', 'message' => 'Backend ParkirGo Terhubung!']);
});
...
Route::middleware(['auth:sanctum', config('jetstream.auth_session'), 'verified'])->group(function () {
    ...
    Route::post('/parkirgo/zones/decode-qris', [ZoneController::class, 'decodeQris'])->name('parkirgo.zones.decode-qris');
    ...
    // Tariffs CRUD
    Route::post('/parkirgo/tariffs', [TariffController::class, 'store'])->name('parkirgo.tariffs.store');
    Route::put('/parkirgo/tariffs/{tariff}', [TariffController::class, 'update'])->name('parkirgo.tariffs.update');
    Route::delete('/parkirgo/tariffs/{tariff}', [TariffController::class, 'destroy'])->name('parkirgo.tariffs.destroy');
    ...
    Route::post('/parkirgo/users/{user}/generate-qr', [AdminController::class, 'generateQrToken'])->name('parkirgo.users.generate-qr');
    Route::post('/parkirgo/users/{user}/revoke-qr', [AdminController::class, 'revokeQrToken'])->name('parkirgo.users.revoke-qr');

    // Shifts CRUD
    Route::get('/parkirgo/shifts', [ShiftController::class, 'index'])->name('parkirgo.shifts');
    ...
    Route::resource('/parkirgo/vehicle-types', VehicleTypeController::class)
        ...
        ->names('parkirgo.vehicle-types');

    Route::resource('/parkirgo/penalties', PenaltyController::class)->except(['show'])->names('parkirgo.penalties');
