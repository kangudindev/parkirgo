...
export default {
    ...
    mounted() {
        ...
        document.querySelector('.currentyear').innerHTML = new Date().getFullYear() + " © ParkirGo";
    },
};
</script>
                    ...
                    <BCol lg="8" sm="10">
                        <div class="text-center mt-lg-5 pt-5">
                            <h1 class="display-6 fw-semibold mb-3 lh-base">The better way to manage your website with
                                <span class="text-success">ParkirGo </span>
                            </h1>
                            <p class="lead text-muted lh-base">ParkirGo is a modern parking management system built with
                                Laravel + Vue.</p>
        ...
        <section class="py-5 bg-primary position-relative">
            ...
            <BContainer>
                <BRow class="align-items-center gy-4">
                    <BCol sm>
                        <div>
                            <h4 class="text-white mb-0 fw-semibold">Manage your parking lot with ParkirGo dashboard</h4>
                        </div>
                    </BCol>
                    <BCol sm="auto">
                        <div>
                            <Link href="https://parkirgo.app" target="_blank"
            ...
            <BContainer>
                        ...
                        <div>
                            ...
                            <div class="mt-4 fs-13">
                                ...
                                <p class="ff-secondary">You can build any type of web application like eCommerce, CRM,
                                    CMS, Project
                                    management apps, Admin Panels, etc using ParkirGo.</p>
                            </div>
                        </div>
                    </BCol>
                ...
                <BRow class="text-center text-sm-start align-items-center mt-5">
                    <BCol sm="6">
                        ...
                        <div>
                            <p class="copy-rights mb-0 currentyear">{{ new Date().getFullYear() }} © ParkirGo
                            </p>
                        </div>
                    </BCol>
                    <BCol sm="6">
