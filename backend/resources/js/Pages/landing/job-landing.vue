                        ...
                        <div class="position-relative home-img text-center mt-5 mt-lg-0">
                            <BCard no-body class="p-3 rounded shadow-lg inquiry-box">
                                <div class="d-flex align-items-center">
                                    ...
                                    <h5 class="fs-15 lh-base mb-0">Work Inquiry from ParkirGo</h5>
                                </div>
                            </BCard>
                    ...
                    <BCol lg="3" md="6">
                        <BCard no-body class="shadow-none">
                            <BCardBody class="p-4">
                                ...
                                <p class="text-muted mb-0 fs-15">Search for your dream jobs from ParkirGo.</p>
                            </BCardBody>
                        </BCard>
                    </BCol>
                    <BCol lg="3" md="6">
