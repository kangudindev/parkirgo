                            ...
                            <BRow class="mb-3">
                                <BCol md>
                                    <BRow class="align-items-center g-3">
                                        ...
                                        <BCol md>
                                            <div>
                                                <h4 class="fw-bold">ParkirGo - Admin & Dashboard</h4>
                                ...
                                <div class="acitivity-timeline py-3">
                                    ...
                                    <div class="acitivity-item py-3 d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <p class="text-muted mb-2">added a new member to ParkirGo dashboard</p>
