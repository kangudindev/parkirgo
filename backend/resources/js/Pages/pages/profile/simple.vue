                        ...
                        <table class="table table-borderless mb-0">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="text-muted">daveadame@parkirgo.app</td>
                            </tr>
                            <tr>
                        ...
                        <BCol cols="6" md="4">
                          <div class="d-flex mt-4">
                            ...
                            <div class="flex-grow-1 overflow-hidden">
                              ...
                              <BLink href="#" class="fw-semibold">www.parkirgo.app</BLink>
                            </div>
                          </div>
                        </BCol>
                      </BRow>
                                    ...
                                    <BCollapse id="collapseFive" visible>
                                      <div class="accordion-body ms-2 ps-5">
                                        <p class="text-muted mb-2">
                                          Every team project can have a ParkirGo.
                                          Use the ParkirGo to share information
                                    ...
                                    <div class="accordion-header" id="heading8">
                                      <BLink class="accordion-button p-2 shadow-none" v-b-toggle.collapse8>
                                        <div class="d-flex">
                                          ...
                                          <div class="flex-grow-1 ms-3">
                                            <h6 class="fs-14 mb-1">
                                              ParkirGo admin dashboard templates
                                              layout upload
                                            </h6>
                  ...
                  <div class="acitivity-timeline">
                    ...
                    <div class="acitivity-item py-3 d-flex">
                      ...
                      <div class="flex-grow-1 ms-3">
                        ...
                        <p class="text-muted mb-2">
                          added a new member to ParkirGo dashboard
                        </p>
                      ...
                      <BCard no-body class="profile-project-card shadow-none profile-project-primary">
                        <BCardBody class="p-4">
                          <div class="d-flex">
                            <div class="flex-grow-1 text-muted overflow-hidden">
                              <h5 class="fs-14 text-truncate">
                                <BLink href="#" class="text-body">ParkirGo Project</BLink>
                              </h5>
                              <p class="text-muted text-truncate mb-0">
                                Last Update :
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  ...
                                  <div class="ms-3 flex-grow-1">
                                    <h6 class="fs-15 mb-0">
                                      <BLink href="javascript:void(0);" class="link-secondary">ParkirGo-logo.png</BLink>
                                    </h6>
                                  </div>
                                </div>
                              </td>
