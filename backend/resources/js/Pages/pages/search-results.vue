          ...
          <BCardBody class="p-4">
            ...
            <BTabs nav-class=" nav-tabs-custom text-muted">
              <BTab class="nav-item">
                ...
                <div class="pb-3 pt-4">
                  <h5 class="mb-1">
                    <BLink href="javascript:void(0);">ParkirGo - Responsive Bootstrap 5 Admin Dashboard</BLink>
                  </h5>
                  <p class="text-success mb-2">
                    https://themesbrand.com/velzon/index.html
                  </p>
                  <p class="text-muted mb-2">
                    ParkirGo admin is super flexible, powerful, clean, modern &
                    ...
                    project using ParkirGo it is very quick and easy as it is
              ...
              <BTab>
                ...
                <BRow class="pt-4">
                  <BCol lg="12" class="video-list">
                      ...
                      <div class="d-flex flex-column flex-sm-row">
                        ...
                        <div class="flex-grow-1 ms-sm-3 mt-2 mt-sm-0">
                          <p class="text-muted mb-0">
                            ParkirGo admin is super flexible, powerful, clean,
                            ...
                            in your existing project using ParkirGo it is very
                    ...
                    <div class="list-element mt-4">
                      <h5 class="mb-1">
                        <BLink href="javascript:void(0);">ParkirGo - The Most Popular Bootstrap 5 HTML, Angular &
                    ...
                    <div class="list-element mt-4">
                      <h5 class="mb-1">
                        <BLink href="javascript:void(0);">ParkirGo Admin Dashboard (website analytics) with
                          Bootstrap 5</BLink>
                      </h5>
                      <p class="text-success">
                        https://themesbrand.com/velzon/index.html
