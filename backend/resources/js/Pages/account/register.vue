            ...
            <BCard no-body class="mt-4">
              ...
              <BCardBody class="p-4">
                <div class="text-center mt-2">
                  ...
                  <p class="text-muted">Get your free ParkirGo account now</p>
                </div>
                <div class="p-2 mt-4">
                  <form class="needs-validation" @submit.prevent="tryToRegisterIn">
                    ...
                    <div class="mb-4">
                      <p class="mb-0 fs-12 text-muted fst-italic">By registering you agree to the ParkirGo <BLink
        ...
        <BRow>
          <BCol lg="12">
            <div class="text-center">
              <p class="mb-0 text-muted">&copy; {{ new Date().getFullYear() }} ParkirGo</p>
            </div>
          </BCol>
        </BRow>
      </BContainer>
